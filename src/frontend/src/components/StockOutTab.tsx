...
import { useAllIngredients, useRecordStockOut, useGetStockTransactionsByType } from '../hooks/useQueries';
...
export default function StockOutTab() {
  ...
  const { data: transactions = [], isLoading: isLoadingTransactions } = useGetStockTransactionsByType(StockTransactionType.stockOut);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await recordStockOut.mutateAsync({
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end pt-4">
              ...
              >
                {recordStockOut.isPending ? 'Recording...' : 'Record Stock Out'}
              </Button>
            </div>
          </form>
        </CardContent>
